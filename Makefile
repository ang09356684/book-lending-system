...
test:
	...
	docker-compose -f docker-compose.yml exec app mvn test jacoco:report
...
test-repo-service:
	...
	docker-compose -f docker-compose.yml exec app mvn test -Dtest=CompleteTestSuite
	@echo "Repository and Service tests completed!"

# Run Repository tests only
test-repo:
	@echo "Running Repository tests only..."
	docker-compose -f docker-compose.yml exec app mvn test -Dtest=RepositoryTestSuite
	@echo "Repository tests completed!"

# Run Service tests only
test-service:
	@echo "Running Service tests only..."
	docker-compose -f docker-compose.yml exec app mvn test -Dtest=ServiceTestSuite
...
test-class:
	...
	docker-compose -f docker-compose.yml exec app mvn test -Dtest=$(CLASS)
